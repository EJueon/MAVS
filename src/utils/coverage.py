...
class Coverage:
    ...
    def scale(self, layer_outputs, rmax: int =1, rmin: int =0):
        '''
    ...
    def vectorCoverage(self, coverages: List, labels: List):
        return self.coverageFunction2(coverages, labels)


    def bitCoverage(self, coverages: List, labels: List):
